...
![facebook_canary_chart_1.jpeg](./2019-04-29-progressive-delivery-with-jenkins-x-automatic-cana/facebook_canary_chart_1.jpeg)
...
![canary_yaml2.png](./2019-04-29-progressive-delivery-with-jenkins-x-automatic-cana/canary_yaml2.png)

然后往 `charts/myapp/values.yaml` 追加如下内容，将 `myapp.example.com` 修改为你的主机名或域名：

![values_yaml_0.png](./2019-04-29-progressive-delivery-with-jenkins-x-automatic-cana/values_yaml_0.png)
...
![canary_analysis.png](./2019-04-29-progressive-delivery-with-jenkins-x-automatic-cana/canary_analysis.png)
